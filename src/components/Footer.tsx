            ...
            <div className="max-w-5xl mx-auto grid md:grid-cols-3 gap-10 text-center md:text-left">
                ...
                <div className="grid grid-cols-2 gap-6 sm:gap-12 md:contents w-full max-w-md sm:max-w-none sm:px-8 mx-auto items-start">
                    ...
                    <div className="flex flex-col items-center md:items-start w-full gap-2">
                        <p className="text-white font-semibold uppercase text-sm tracking-wide mb-2">Navegación</p>
                        <Link to="/" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="text-sm no-underline text-gray-400 hover:text-brand-gold transition-colors py-1">Inicio</Link>
                        <Link to="/horarios" className="text-sm no-underline text-gray-400 hover:text-brand-gold transition-colors py-1">Horarios</Link>
                        <Link to="/servicios" className="text-sm no-underline text-gray-400 hover:text-brand-gold transition-colors py-1">Servicios</Link>
                        <Link to="/tarifas" className="text-sm no-underline text-gray-400 hover:text-brand-gold transition-colors py-1">Tarifas</Link>
                        <Link to="/sobre-nosotros" className="text-sm no-underline text-gray-400 hover:text-brand-gold transition-colors py-1">Sobre nosotros</Link>
                        <Link to="/ubicacion" className="text-sm no-underline text-gray-400 hover:text-brand-gold transition-colors py-1">Ubicación</Link>
                        <Link to="/contacto" className="text-sm no-underline text-gray-400 hover:text-brand-gold transition-colors py-1">Contacto</Link>
                    </div>
                    ...
                    <div className="flex flex-col items-center md:items-start w-full gap-2">
                        ...
                        >
                            <svg className="text-brand-gold" width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
