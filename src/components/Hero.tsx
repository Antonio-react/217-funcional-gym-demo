        ...
        <div className="max-w-7xl mx-auto px-6 md:px-10 w-full">
          ...
          >
            ...
            <div className="flex gap-4">
              <Link
                to="/contacto"
                className="bg-yellow-500 hover:bg-yellow-400 active:scale-95 text-black font-semibold px-6 sm:px-8 py-3 rounded-lg text-base sm:text-lg transition shadow-lg shadow-yellow-500/20"
              >
                Empieza hoy
              </Link>
              ...
              <Link
                to="/horarios"
                className="border border-white/30 text-white bg-black/40 backdrop-blur-sm px-6 sm:px-8 py-3 rounded-lg text-base sm:text-lg hover:bg-white/10 active:scale-95 transition"
              >
                Ver horarios
              </Link>
            </div>
