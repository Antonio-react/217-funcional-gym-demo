...
import bannerDesktop from "../assets/Mancuernero-desktop.webp";
import bannerMobile from "../assets/Mancuernero-mobile.webp";
    ...
    <>
      <section className="relative h-[60svh] bg-cover bg-center overflow-hidden">
        <picture className="absolute inset-0 w-full h-full pointer-events-none">
          ...
          <img
            src={bannerMobile}
            alt="Precios y cuotas de suscripción en 217 GYM"
            fetchPriority="high"
            loading="eager"
            width="800"
            height="1200"
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            <m.div variants={tarjetaVariants}>
              <Link
                to="/horarios"
                className="group bg-zinc-900/80 backdrop-blur-md p-8 rounded-2xl border border-zinc-800 shadow-xl transition-all duration-300 hover:scale-105 hover:-translate-y-1 hover:border-white/20 block"
              >
                <p className="text-base text-brand-gold-dark uppercase tracking-wide mb-3">
                  Plan de Mañana
                </p>
                <p className="text-4xl font-bold">27,99 €</p>
                <p className="text-sm text-gray-400 mt-2 mb-3">al mes</p>
                <p className="text-xs uppercase text-brand-gold-dark">
                  * Horario Especial
                </p>
              </Link>
            </m.div>
            ...
            >
              <p className="text-base text-gray-400 font-sans uppercase tracking-wide mb-3">
                Plan mensual
              </p>
            ...
            >
              ...
              <p className="text-base text-gray-400 uppercase tracking-wide mb-3">
                Plan 3 meses
              </p>
              <p className="text-4xl font-bold text-brand-gold-dark">31,66 €</p>
              <p className="text-sm text-gray-400 mt-1">al mes</p>
              <p className="text-sm text-neutral-900 mt-2 bg-[#D4B05D] inline-block px-3 py-1 rounded-full">
                <span className="text-base">95 €</span> pago único
              </p>
            </m.div>
            ...
            >
              ...
              <p className="text-sm text-gray-400 mt-1">al mes</p>
              <p className="text-sm text-neutral-900 mt-2 bg-[#D4B05D] inline-block px-3 py-1 rounded-full">
                <span className="text-base">180 €</span> pago único
              </p>
            </m.div>
