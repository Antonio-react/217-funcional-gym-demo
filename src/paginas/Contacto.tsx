...
export default function Contacto() {
    ...
    function enviarWhatsapp(e: React.SubmitEvent<HTMLFormElement>) {
        ...
        const url = `https://wa.me/34600003200?text=${encodeURIComponent(texto)}`
            ...
            <section className="relative bg-black text-white pb-12 px-4 -mt-12">
                ...
                >
                    ...
                    <div className="flex flex-col gap-6 items-center">
                        <a href="tel:619863200" className="flex items-center gap-3 text-gray-300 no-underline hover:text-brand-gold active:text-brand-gold transition-colors">
                            <Phone size={24} className="text-brand-gold" />
                            <span className="text-xl">600 000 200</span>
                        </a>

                        <a href="https://wa.me/34600003200" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-gray-300 no-underline hover:text-brand-gold active:text-brand-gold transition-colors">
                        ...
                        <a href="mailto:217gym@gmail.com" className="flex items-center gap-3 text-gray-300 no-underline hover:text-brand-gold active:text-brand-gold transition-colors">
                            <Mail size={24} className="text-brand-gold" />
                            <span className="text-xl">217gym@gmail.com</span>
                        </a>

                        <a href="https://instagram.com/217_gym" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-gray-300 no-underline hover:text-brand-gold active:text-brand-gold transition-colors">
                            ...
                            <span className="text-xl">@217_gym</span>
                        </a>
                    </div>
                </motion.div>
            </section>

            <section className="relative bg-black text-white pb-12 px-4">
                <motion.div
                    initial={{ opacity: 0, y: 40 }}
                    whileInView={{ opacity: 1, y: 0 }}
                ...
                >
                    ...
                    <form onSubmit={enviarWhatsapp} className="flex flex-col gap-5 text-left">
                        ...
                        <button
                            type="submit"
                            className="border-2 border-brand-gold text-brand-gold bg-brand-gold/10 px-6 py-3 font-semibold uppercase tracking-widest hover:bg-brand-gold hover:text-black active:bg-brand-gold active:text-black active:scale-95 transition-all duration-200"
                        >
                            Enviar por WhatsApp
                        </button>
                    </form>
