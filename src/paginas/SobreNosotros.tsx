...
export default function SobreNosotros() {
  ...
  function fotoAnterior() {
    ...
    setIndiceAmpliado(
      (indiceAmpliado - 1 + fotosGaleria.length) % fotosGaleria.length,
    );
  }
      ...
      <section className="relative bg-black text-white pb-20 px-4 -mt-12">
        ...
        >
          ...
          <p className="text-gray-300 text-base md:text-lg leading-relaxed text-justify">
            No somos otro gimnasio más donde pagas una cuota y se olvidan de tu
            nombre al cruzar el torno. Diseñamos este espacio para gente que
            quiere progresar, superarse a su ritmo y entrenar con libertad.
            Tengas el nivel que tengas, aquí vas a encontrar el equipamiento y
            la comunidad necesarios para cumplir tus metas.
          </p>
        </m.div>
      </section>
      ...
      <section className="bg-almostblack border-y border-gray-700 py-8 px-4">
        ...
        >
          <div className="flex flex-col items-center justify-center">
            ...
            <p className="text-xs text-gray-400 text-center uppercase tracking-wide mt-1 mb-4">
          ...
          <div className="flex flex-col items-center justify-center">
            ...
            <p className="text-xs text-gray-400 text-center uppercase tracking-wide mt-1">
        ...
        >
          <m.div
            ...
            className="flex-1 flex flex-col items-center justify-center min-[600px]:px-2 md:px-6 lg:px-12"
          >
        ...
        >
          {[galeria1, galeria2, galeria3, galeria4, galeria5, galeria6].map(
            (foto, i) => (
              <div
                key={i}
                className="snap-center shrink-0 w-[85%] overflow-hidden rounded-xl"
              >
                <img
                  src={foto}
                  alt={`Instalaciones 217 GYM ${i + 1}`}
